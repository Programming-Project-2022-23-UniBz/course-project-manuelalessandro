package DesignObjects.SteelCheckBox;
...
public class SteelCheckBoxUI extends javax.swing.plaf.basic.BasicCheckBoxUI
        ...
        private void init() {
                foreground = new java.awt.geom.RoundRectangle2D.Double(
                                pos.x + backgroundImage.getWidth() * 0.03846153989434242,
                                pos.y + backgroundImage.getHeight() * 0.0714285746216774,
                                backgroundImage.getWidth() * 0.923076868057251,
                                backgroundImage.getHeight() * 0.8571428060531616,
                ...
                foregroundGradient = new java.awt.LinearGradientPaint(foregroundStart, foregroundStop,
        ...
        public synchronized void paint(java.awt.Graphics g, javax.swing.JComponent component) {
                ...
                final java.awt.font.FontRenderContext RENDER_CONTEXT = new java.awt.font.FontRenderContext(null, true,
                                true);
                final java.awt.font.TextLayout TEXT_LAYOUT = new java.awt.font.TextLayout(CHECKBOX.getText(),
                                G2.getFont(),
                                RENDER_CONTEXT);
                final java.awt.geom.Rectangle2D BOUNDS = TEXT_LAYOUT.getBounds();
                G2.drawString(CHECKBOX.getText(), backgroundImage.getWidth() + 5,
                                (CHECKBOX.getBounds().height - BOUNDS.getBounds().height) / 2
        ...
        private java.awt.image.BufferedImage create_KNOB_Image(final int WIDTH, final boolean PRESSED) {
                ...
                final java.awt.image.BufferedImage IMAGE = GFX_CONF.createCompatibleImage(WIDTH, WIDTH,
                ...
                final java.awt.geom.Ellipse2D KNOB_FRAME = new java.awt.geom.Ellipse2D.Double(IMAGE_WIDTH * 0.0,
                                IMAGE_HEIGHT * 0.0, IMAGE_WIDTH * 1.0, IMAGE_HEIGHT * 1.0);
                final java.awt.geom.Point2D KNOB_FRAME_START = new java.awt.geom.Point2D.Double(0,
                                KNOB_FRAME.getBounds2D().getMinY());
                final java.awt.geom.Point2D KNOB_FRAME_STOP = new java.awt.geom.Point2D.Double(0,
                                KNOB_FRAME.getBounds2D().getMaxY());
                ...
                if (KNOB_FRAME_START.distance(KNOB_FRAME_STOP) > 0) {
                        final java.awt.LinearGradientPaint KNOB_FRAME_GRADIENT = new java.awt.LinearGradientPaint(
                                        KNOB_FRAME_START,
                ...
                final java.awt.geom.Ellipse2D KNOB = new java.awt.geom.Ellipse2D.Double(
                                IMAGE_WIDTH * 0.07692307978868484,
                                IMAGE_HEIGHT * 0.07692307978868484, IMAGE_WIDTH * 0.8461538553237915,
                                IMAGE_HEIGHT * 0.8461538553237915);
                final java.awt.geom.Point2D KNOB_CENTER = new java.awt.geom.Point2D.Double(KNOB.getCenterX(),
                                KNOB.getCenterY());
                ...
                final ConicalGradientPaint KNOB_GRADIENT = new ConicalGradientPaint(true, KNOB_CENTER, 0f,
                                KNOB_FRACTIONS,
                                KNOB_COLORS);
        ...
        private java.awt.image.BufferedImage create_BACKGROUND_Image(final int WIDTH) {
                ...
                final java.awt.GraphicsConfiguration GFX_CONF = java.awt.GraphicsEnvironment
                                .getLocalGraphicsEnvironment()
                                .getDefaultScreenDevice().getDefaultConfiguration();
                final java.awt.image.BufferedImage IMAGE = GFX_CONF.createCompatibleImage(WIDTH,
                                (int) (0.5384615384615384 * WIDTH), java.awt.Transparency.TRANSLUCENT);
                final java.awt.Graphics2D G2 = IMAGE.createGraphics();
                G2.setRenderingHint(java.awt.RenderingHints.KEY_ANTIALIASING,
                                java.awt.RenderingHints.VALUE_ANTIALIAS_ON);
                ...
                final java.awt.geom.RoundRectangle2D BACKGROUND_FRAME = new java.awt.geom.RoundRectangle2D.Double(
                                IMAGE_WIDTH * 0.0, IMAGE_HEIGHT * 0.0, IMAGE_WIDTH * 1.0, IMAGE_HEIGHT * 1.0,
                                IMAGE_HEIGHT,
                                IMAGE_HEIGHT);
                ...
                final java.awt.LinearGradientPaint BACKGROUND_FRAME_GRADIENT = new java.awt.LinearGradientPaint(
                                BACKGROUND_FRAME_START, BACKGROUND_FRAME_STOP, BACKGROUND_FRAME_FRACTIONS,
                                BACKGROUND_FRAME_COLORS);
                G2.setPaint(BACKGROUND_FRAME_GRADIENT);
                G2.fill(BACKGROUND_FRAME);

                final java.awt.geom.RoundRectangle2D BACKGROUND = new java.awt.geom.RoundRectangle2D.Double(
                                IMAGE_WIDTH * 0.03846153989434242, IMAGE_HEIGHT * 0.0714285746216774,
                                IMAGE_WIDTH * 0.923076868057251,
                                IMAGE_HEIGHT * 0.8571428060531616, IMAGE_HEIGHT, IMAGE_HEIGHT);
                final java.awt.geom.Point2D BACKGROUND_START = new java.awt.geom.Point2D.Double(0,
                                BACKGROUND.getBounds2D().getMinY());
                final java.awt.geom.Point2D BACKGROUND_STOP = new java.awt.geom.Point2D.Double(0,
                                BACKGROUND.getBounds2D().getMaxY());
        ...
        public java.awt.geom.Point2D getCenteredTextPosition(final java.awt.Graphics2D G2,
                        final java.awt.geom.Rectangle2D BOUNDARY, final java.awt.Font FONT, final String TEXT,
