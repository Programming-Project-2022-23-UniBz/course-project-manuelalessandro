...
public class LoginFrame extends javax.swing.JFrame {
    ...
    private void registerUser() {
        try {
            ...
            if (!User.nameValid(name, surname))
                ...
                JOptionPane.showMessageDialog(this,
                        "You registered successfully as " + username, "",
                        JOptionPane.WARNING_MESSAGE);
    ...
    private void initComponents() {
        ...
        genderComboBox.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Man", "Woman", "Other" }));
        ...
        loginPanel.add(loginRegisterButton, new org.netbeans.lib.awtextra.AbsoluteConstraints(230, 290, 140, -1));
